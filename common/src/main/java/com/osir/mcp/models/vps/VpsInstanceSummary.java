...
public class VpsInstanceSummary {
    ...
    // OS build state. Distinct from `status` (ACTIVE/SUSPENDED/...), which describes the subscription,
    // not whether the box actually has an operating system on it.
    /** UNBUILT | QUEUED | BUILDING | COMPLETE | FAILED. Only the detail endpoint reads it live. */
    private String buildState;
    /** VirtFusion's own timestamp of the last completed build; null if never built. */
    private String built;
    private Boolean buildFailed;
    private Integer osTemplateId;
    /** e.g. "Debian 12 (Bookworm) Minimal" */
    ...
    public Boolean getBuildFailed() { return buildFailed; }
