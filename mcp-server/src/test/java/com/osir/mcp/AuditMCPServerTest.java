...
class AuditMCPServerTest {
    ...
    void getDomainAuditTrail_delegatesToService() {
        ...
        assertSame(expected, mcpServer.getDomainAuditTrail("example.com", null, mockConnection));
    }
    ...
    void getDomainAuditTrail_handlesException() {
        ...
        assertFalse(mcpServer.getDomainAuditTrail("example.com", null, mockConnection).isSuccess());
    }
    ...
    void getMyAuditLogs_delegatesToService() {
        ...
        assertSame(expected, mcpServer.getMyAuditLogs(null, null, null, mockConnection));
    }

    @Test
    void getMyAuditLogs_handlesException() {
        when(auditService.getMyAuditLogs(null, null)).thenThrow(new RuntimeException("Fail"));
        assertFalse(mcpServer.getMyAuditLogs(null, null, null, mockConnection).isSuccess());
    }
    ...
    void getRecentActivity_delegatesToService() {
        ...
        assertSame(expected, mcpServer.getRecentActivity(null, mockConnection));
    }

    @Test
    void getRecentActivity_handlesException() {
        when(auditService.getRecentActivity()).thenThrow(new RuntimeException("Fail"));
        assertFalse(mcpServer.getRecentActivity(null, mockConnection).isSuccess());
    }
}
